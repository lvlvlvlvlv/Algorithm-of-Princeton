...
//        StdOut.println(p.slopeTo(c));
//        StdOut.println(p.slopeTo(d));
//        StdOut.println("==================");
//        StdOut.println(p.compareTo(a));
//        StdOut.println(p.compareTo(b));
//        StdOut.println(p.compareTo(c));
//        StdOut.println(p.compareTo(d));
        StdOut.println(p.slopeOrder().compare(d,c));
